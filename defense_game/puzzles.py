...
PUZZLES: list[Puzzle] = [
    Puzzle(
        ...
        tip="傳右衛甩掉逼搶 → 傳左翼換邊 → 盤 (0,5) → 回傳前鋒 → 射 (4,7)。",
        attackers=[
            _atk("A1", "中場", 1, 2),
            _atk("A2", "右衛", 6, 0),
            _atk("A3", "左翼", 0, 4),
    ...
    Puzzle(
        ...
        tip="邊衛移 (6,2) 結束 → 移 (6,3) 結束 → 傳邊衛 → 內切 (5,4) → 射 (4,7)。",
        attackers=[
            _atk("A1", "前腰", 3, 2),
            _atk("A2", "邊衛", 6, 1),
            _atk("A3", "前鋒", 1, 4),
    ...
    Puzzle(
        ...
        tip="前腰移 (4,2) 結束 → 移 (4,3) 結束 → 直塞前腰 → 盤 (5,4) → 射 (4,7)。",
        attackers=[
            _atk("A1", "邊鋒", 6, 2),
            _atk("A2", "前腰", 4, 1),
            _atk("A3", "前鋒", 0, 3),
    ...
    Puzzle(
        ...
        tip="盤 (0,3) 結束 → (0,4) → 前鋒插 (5,4) → 倒三角 → 射 (4,7)。",
        attackers=[
            _atk("A1", "左翼", 0, 2),
            _atk("A2", "前鋒", 4, 3),
            _atk("A3", "右翼", 6, 1),
    ...
    Puzzle(
        ...
        tip="傳給牆 → 結束 → 插上 (1,3) → 接回傳 → 傳邊 → 射 (4,7)。",
        attackers=[
            _atk("A1", "持球", 2, 2),
            _atk("A2", "牆", 4, 2),
            _atk("A3", "前鋒", 0, 3),
    ...
    Puzzle(
        ...
        tip="盤 (0,3) → (0,4) → (0,5) 下底 → 倒三角給前鋒 → 射 (4,7)。",
        attackers=[
            _atk("A1", "左翼", 0, 2),
            _atk("A2", "前鋒", 4, 3),
            _atk("A3", "右翼", 6, 1),
