% 編譯：cd docs && xelatex PHYSICAL_GAME_RULES.tex
...
\begin{itemize}
  ...
  \item 移格完成後，球員必須站在該格內。
  \item 在非移動階段時，球員不得擅自離開原所屬格。
  \item 球員可在自己的格內轉身、調整身體、傳球、接球、攔截或撲救。
\end{itemize}
...
在此階段所有隊員皆可移動，每位小隊員僅能移動一次。持球者移動定義為盤帶，非持球者移動定義為無球跑位。兩者合法操作須符合：
...
\begin{enumerate}
  \item 持球者宣告接球隊友；
  \item 若關卡區分傳球種類，宣告地滾或高空；
  \item 確認所有人站在所屬格內；
  \item 持球者在自己的格內實際傳球；
  \item 指定接球者在自己的格內實際接球。
\end{enumerate}

\subsubsection*{4.4.2 傳球成功}

同時符合：

\begin{enumerate}
  \item 接球者需觸球；
  \item 接球者觸球起至球停止移動時球皆未離開格子；
  \item 所有球員雙腳皆未離開格子；
  \item 防守方並未觸球。
\end{enumerate}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item 若合法範圍內沒有空格 $\rightarrow$ 若原位仍空則留在原位；定點者永遠留在原位。（在 7$\times$8 與上述優先序下，原位被佔且無替代格的情況不應發生；若發生則屬執行錯誤，不得用瞬移或跨區解決。）
\end{enumerate}
